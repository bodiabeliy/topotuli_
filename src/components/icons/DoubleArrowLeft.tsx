...
export const BouncedLeftArrow = (props: TypeIconProps) => {
  const {fill, className} = props
  return (
    <svg className={className} fill={fill} width="24" height="24" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" 
	 viewBox="0 0 330 330">
<g id="XMLID_106_">
